              ...
              <div className="flex flex-wrap gap-3">
                {techs.map((tech, techIndex) => (
                  <Badge 
                    key={tech}
                    variant="secondary"
                    className="px-4 py-2 text-base backdrop-blur-sm bg-card/50 border border-primary/20 hover:border-primary/50 hover:bg-primary/10 transition-all cursor-default animate-scale-in"
